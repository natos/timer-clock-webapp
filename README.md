...
Add timer-clock app
    ...
    git submodule add git@github.com:natos/timer-clock.git site/static/timer-clock
    git submodule init
    git submodule update

Now you can get updates to timer-clock in the future by updating the submodule:

    git submodule update --remote site/static/timer-clock
